...
public class FaceBookPage  extends  Utils{
   ...
   private By _emailPlaceHolder = By.xpath("//*[@id=\"login_form\"]/div[2]/div[1]/label/input");
   private By _passwordPlaceHolder = By.xpath("//*[@id=\"login_form\"]/div[2]/div[2]/label/input");
   private By _loginButton = By.xpath("//*[@id=\"login_form\"]/div[2]/div[3]/div/div/div[1]/div/span/span");

    public void UserShouldBeAbleTOLoginFaceBook() {
